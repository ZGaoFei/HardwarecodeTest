...
public class XBuild {
    ...
    public void BuildProp(XC_LoadPackage.LoadPackageParam loadPkgParam, HookEntity hookEntity) {
        /*
        try {
            ...
            XposedHelpers.findField(Build.VERSION.class, "RELEASE").set(null, SharedPref.getXValue("AndroidVer"));
            XposedHelpers.findField(Build.VERSION.class, "SDK").set(null, SharedPref.getXValue("API"));
            ...
            XposedHelpers.findAndHookMethod("android.provider.Settings.Secure", loadPkgParam.classLoader, "getString", ContentResolver.class, String.class, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param)
                    ...
                    if (param.args[1].equals(Settings.Secure.ANDROID_ID)) {
                        param.setResult(hookEntity.getAndroidId());
                    }
                }
            });
