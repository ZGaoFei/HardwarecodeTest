...
import com.demo.hardwarecodetest.Utis.Mnt;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        editText = findViewById(R.id.et_device_id);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_reload:
                ...
                tvCurrentDeviceId.setText(imei);
                break;
            case R.id.bt_save:
                if (editText != null) {
                    String trim = editText.getText().toString().trim();
                    Utils.saveDeviceIdToFile(trim);
                }
                break;
    ...
    private void changer() {
        ...
        Log.e("test", "========changer=======hookData==" + hookData);
        HookEntity hookEntity = Utils.stringToEntity(hookData);
        Log.e("test", "=====changer======hookEntity==" + hookEntity.toString());
    }
